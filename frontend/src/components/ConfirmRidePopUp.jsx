  ...
  return (
    <div>
        ...
        <div className='flex gap-2 justify-between items-center flex-col'>
            ...
            <Link to='/captain-riding' className='w-full text-xl text-white flex justify-center font-bold bg-green-600 p-2 rounded-xl mt-5'>Confirm</Link>
            <button onClick={()=>{
                props.setConfirmRidePopUpPanel(false)
                props.setRidePopUpPanel(false)
            }} className='w-full text-xl text-white font-bold bg-red-600 p-2 rounded-xl mt-2'>Cancel</button>
        </div>
    </div>
  )
}
