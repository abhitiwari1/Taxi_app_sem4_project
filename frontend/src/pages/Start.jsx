...
import appLogo from '../assets/applogo.png'; // adjust path as needed
...
const Start = () => {
  return (
    <div>
      ...
      <div className="ml-16 w-32 p-1 bg-white/60 rounded-md shadow-md">
        <img className="w-full" src={appLogo} alt="App Logo" />
      </div>
        <div className='bg-white pb-8 py-4 px-4'>
          <h2 className='text-[30px] font-semibold'>Get Started with Taxi App</h2>
